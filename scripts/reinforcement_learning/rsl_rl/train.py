...
from isaaclab_tasks.utils import get_checkpoint_path, launch_simulation, setup_cli
...
# Register preset + launcher flags and parse argv. `commit=False` because the
# external-callback flow below trims the leftover argv before Hydra sees it.
...
remaining_args = preset_cli.apply(args_cli, remaining_args)
