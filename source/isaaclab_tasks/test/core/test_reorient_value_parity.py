...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(AllegroHandEnvCfg, AllegroCubeEnvCfg, id="allegro"),
...
def test_manager_config_matches_direct_values(direct_cls, manager_cls):
    ...
    # Both workflows publish ``Metrics/success_rate``; the curves only compare if the
    # episode-success bit is drawn at the same goal count.
